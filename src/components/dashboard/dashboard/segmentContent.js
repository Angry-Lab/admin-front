...
export const segmentContent1 = () => <>
            ...
            <Typography gutterBottom>
                🔹   Предложить выгодные условия для сотрудничества в первые месяцы, с целью увеличения клиентской базы.
            </Typography>
            <Typography gutterBottom>
...
export const segmentContent3 = <>
    ...
    <Typography gutterBottom>
        🔸    Программа уровней, при которой клиенту будет предоставляться кешбек/бонусы на следующие
        отправки, и чем больше человек совершает посылок, тем больше он получает бонусов.
    </Typography>
</>;
