...
const data = [
    {
        name: 'Юр. лица', uv: 4000, pv: 37.7, amt: 2400,
    },
    {
...
export default class NotActiveUserChart extends PureComponent {
    ...
    render() {
        return (
            ...
            >
                ...
                <Legend />
                <Bar name='Среднее кол-во посылок' dataKey="pv" barSize={20} fill="#8884d8" />
            </BarChart>
        );
    }
}
